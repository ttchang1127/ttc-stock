...
- **DuPont ROE**: **-29.93%**（淨利率 **-260.66%** × 資產週轉率 **0.045x** × 權益乘數 **2.564x**）
- **ROE 直接驗算 (淨利 ÷ 股東權益)**: **-29.93%**
...
- **美股現價**: **$6.80 USD**
- **總市值 (Market Cap)**: **~$969 Million ($9.69 億美元)**
- **企業價值 (EV = Market Cap - Net Cash)**: **~$420 Million ($4.20 億美元)**

---

## 🎲 五、 DCF 蒙地卡羅 10,000 次估值模擬 (營收成長率 $g=38.0\%$, WACC=$10.5\%$)

- **平均內在價值 (Mean Intrinsic Value)**: **$7.19 USD**
- **中位數內在價值 (Median Intrinsic Value)**: **$7.01 USD**
- **50% 核心估值區間 (P25 ~ P75)**: **$6.37 ~ $7.78 USD**
- **95% 機率上限 (P95 Bullish Ceiling)**: **$9.30 USD**
