...
> 📌 假設來源：`dcf_assumptions.json`（沿用先前 thesis 標題：Azure/AI g=13%, WACC=8.5%）。基期自由現金流 $96,704 百萬，預測 10 年後接終端價值，共 10,000 次有效模擬。

| 分位 | P5 | P25 | P50 (中位數) | P75 | P95 |
|---|---|---|---|---|---|
| 每股內在價值 | $336.40 | $425.35 | **$504.58** | $603.70 | $788.09 |

- **平均內在價值**: **$526.22**
- **50% 主流估值區間 (P25 ~ P75)**: **$425.35 ~ $603.70**
- **現價 $499.99 相對中位數**: 低於中位數 **0.9%**
- **現價隱含的 FCF 年成長率**: **12.9%**（在 WACC 8.50% 與同組終端假設下，讓模型值等於現價所需的成長率）
