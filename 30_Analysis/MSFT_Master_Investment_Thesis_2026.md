...
- **近 12 個月 Sortino Ratio（日資料，MAR=0）**: **0.37**　（2025-09-25 ~ 2026-09-25，251 個交易日）
...
> 📌 本節全部由 SEC 財報數字與 `prices.json` 收盤價計算，股價為 2026-09-25 之 $516.17。
...
- **現價 $516.17 相對中位數**: 高於中位數 **3.2%**
- **現價隱含的 FCF 年成長率**: **15.0%**（在 WACC 9.20% 與同組終端假設下，讓模型值等於現價所需的成長率）
