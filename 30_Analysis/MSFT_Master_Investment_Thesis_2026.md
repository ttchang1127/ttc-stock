...
- **近 5 年 Sortino Ratio（週資料）**: **0.87**　（2021-08-20 ~ 2026-08-14，260 週報酬）

**對照公開篩選器（日資料）**

- **近 12 個月 Sortino Ratio（日資料，MAR=0）**: **0.02**　（2025-08-14 ~ 2026-08-14，251 個交易日）
  - 若改以無風險利率為門檻（3.69%，^IRX 13週美國國庫券，期間平均）則為 **-0.15**
...
> 📌 本節全部由 SEC 財報數字與 `prices.json` 收盤價計算，股價為 2026-08-14 之 $495.40。
...
- **現價 $495.40 相對中位數**: 低於中位數 **1.0%**
- **現價隱含的 FCF 年成長率**: **14.5%**（在 WACC 9.20% 與同組終端假設下，讓模型值等於現價所需的成長率）
