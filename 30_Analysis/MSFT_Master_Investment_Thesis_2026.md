...
- **當前本益比 (P/E Ratio at $392.71)**: **28.8x** 🌟 *(評價極具吸引力！低於 Apple 的 44.7x 與 NVDA 的 39.9x)*
- **股東總殖利率 (Total Shareholder Yield)**: **1.45%** (包含每年 $240.8 億股利與 $184.2 億庫藏股回購)
...
```
      ...
      P5 (5% 極端下限)      P25 (保守分位)        P50 (中位數)       P75 (樂觀分位)      P95 (95% 機率上限)
        $212.80           $249.54        $282.98       $321.41           $397.97
```

- **平均內在價值 (Mean Intrinsic Value)**: **$290.74 USD**
- **中位數內在價值 (Median Intrinsic Value)**: **$282.98 USD**
- **50% 主流估值區間 (P25 ~ P75)**: **$249.54 ~ $321.41 USD**
- **95% 機率上限 (P95 Bullish Ceiling)**: **$397.97 USD**

*現價 ($392.71 美元) 位於蒙地卡羅估值中高區間，考量其 P/E 僅 28.8x，且 Azure + AI Copilot 擁有全美股最強的 B2B 訂閱防禦力，具備極強的長期投資吸引力。*
