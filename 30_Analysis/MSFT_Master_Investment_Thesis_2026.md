...
- **近 3 年 Sortino Ratio（週資料）**: **1.19**　（2023-09-08 ~ 2026-09-03，156 週報酬）
- **近 5 年 Sortino Ratio（週資料）**: **0.92**　（2021-09-03 ~ 2026-09-03，261 週報酬）

**對照公開篩選器（日資料）**

- **近 12 個月 Sortino Ratio（日資料，MAR=0）**: **0.33**　（2025-09-03 ~ 2026-09-03，252 個交易日）
  - 若改以無風險利率為門檻（3.67%，^IRX 13週美國國庫券，期間平均）則為 **0.16**
...
> 📌 本節全部由 SEC 財報數字與 `prices.json` 收盤價計算，股價為 2026-09-03 之 $510.12。
...
- **現價 $510.12 相對中位數**: 高於中位數 **2.0%**
- **現價隱含的 FCF 年成長率**: **14.9%**（在 WACC 9.20% 與同組終端假設下，讓模型值等於現價所需的成長率）
