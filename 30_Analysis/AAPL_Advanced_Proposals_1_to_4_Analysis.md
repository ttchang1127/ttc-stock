...
- **現金股利發放 (Dividends Paid)**: **$154.0 億美元** $\implies$ **股利殖利率 (Dividend Yield): 0.31%**
- **庫藏股回購 (Share Repurchases)**: **$893.0 億美元** $\implies$ **庫藏股殖利率 (Buyback Yield): 1.78%**
- 🌟 **股東總殖利率 (Total Shareholder Yield = Dividend + Buyback)**: **2.09%** (實質回饋股利與縮減股數的複合收益)
- 💰 **自由現金流收益率 (FCF Yield on EV)**: **1.99%** (經營產出現金流與企業價值的真實對比)
...
- **平均內在價值 (Mean Intrinsic Value)**: **$139.28 USD**
- **中位數內在價值 (Median Intrinsic Value)**: **$136.28 USD**
- **5% 極端悲觀百分位 (P5 Conservative Floor)**: **$106.08 USD**
- **25% 保守分位 (P25 Lower Quartile)**: **$122.07 USD**
- **75% 樂觀分位 (P75 Upper Quartile)**: **$152.49 USD**
- **95% 極端樂觀百分位 (P95 Bullish Ceiling)**: **$183.89 USD**
...
```
      ...
      P5 (5% 機率下限)      P25 (保守區間)       P50 (中位數)       P75 (樂觀區間)       P95 (95% 機率上限)
        $106.08            $122.07        $136.28       $152.49           $183.89
```
