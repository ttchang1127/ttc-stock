...
- **DuPont ROE**: **-0.21%**（淨利率 **-0.51%** × 資產週轉率 **0.250x** × 權益乘數 **1.673x**）
- **ROE 直接驗算 (淨利 ÷ 股東權益)**: **-0.21%**
...
- **當前本益比 (P/E Ratio)**: **180.0x**

---

## 🎲 五、 DCF 蒙地卡羅 10,000 次估值模擬

- **中位數內在價值 (Median Intrinsic Value)**: **$-8.86 USD**
- **50% 核心估值區間 (P25 ~ P75)**: **$-9.20 ~ $-8.58 USD**
