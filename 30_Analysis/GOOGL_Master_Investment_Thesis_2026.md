...
> 📌 假設來源：`dcf_assumptions.json`（沿用先前 thesis 標題：Cloud/Gemini g=13.5%, WACC=8.5%）。基期自由現金流 $88,272 百萬，預測 10 年後接終端價值，共 10,000 次有效模擬。

| 分位 | P5 | P25 | P50 (中位數) | P75 | P95 |
|---|---|---|---|---|---|
| 每股內在價值 | $196.27 | $247.87 | **$292.32** | $347.95 | $452.48 |

- **平均內在價值**: **$304.53**
- **50% 主流估值區間 (P25 ~ P75)**: **$247.87 ~ $347.95**
- **現價 $353.47 相對中位數**: 高於中位數 **20.9%**
- **現價隱含的 FCF 年成長率**: **16.0%**（在 WACC 8.50% 與同組終端假設下，讓模型值等於現價所需的成長率）
