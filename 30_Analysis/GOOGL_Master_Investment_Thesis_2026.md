...
- **近 3 年 Sortino Ratio（週資料）**: **2.05**　（2023-09-22 ~ 2026-09-21，157 週報酬）
- **近 5 年 Sortino Ratio（週資料）**: **1.16**　（2021-09-24 ~ 2026-09-21，261 週報酬）

**對照公開篩選器（日資料）**

- **近 12 個月 Sortino Ratio（日資料，MAR=0）**: **2.00**　（2025-09-22 ~ 2026-09-21，250 個交易日）
  - 若改以無風險利率為門檻（3.67%，^IRX 13週美國國庫券，期間平均）則為 **1.80**
...
> 📌 本節全部由 SEC 財報數字與 `prices.json` 收盤價計算，股價為 2026-09-21 之 $350.87。
...
- **現價 $350.87 相對中位數**: 高於中位數 **12.1%**
- **現價隱含的 FCF 年成長率**: **18.7%**（在 WACC 9.63% 與同組終端假設下，讓模型值等於現價所需的成長率）
