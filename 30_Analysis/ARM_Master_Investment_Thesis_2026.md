...
|---|---|---|---|---|---|
| 每股內在價值 | $12.82 | $15.20 | **$17.31** | $19.95 | $25.01 |

- **平均內在價值**: **$17.92**
- **50% 主流估值區間 (P25 ~ P75)**: **$15.20 ~ $19.95**
- **現價 $282.57 相對中位數**: 高於中位數 **1532.4%**
- **現價隱含的 FCF 年成長率**: **65.5%**（在 WACC 17.73% 與同組終端假設下，讓模型值等於現價所需的成長率）

> 🚨 **中位數 $17.31 與現價 $282.57 相差 -94%，超過 ±50% 門檻。這個幅度通常反映假設不適用，而非市場錯價 —— 請以下方的隱含成長率判讀，不要把中位數當成目標價**
