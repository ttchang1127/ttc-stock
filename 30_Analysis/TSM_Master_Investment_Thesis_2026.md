...
- **DuPont ROE**: **27.27%**（淨利率 **39.99%** × 資產週轉率 **0.432x** × 權益乘數 **1.577x**）
- **ROE 直接驗算 (淨利 ÷ 股東權益)**: **27.27%**
...
- **近 3 年 Sortino Ratio (週資料)**: **2.44** 🌟 (得益於 AI 晶片需求爆發與產能滿載，表現極其優秀)
- **近 5 年 Sortino Ratio (週資料)**: **1.24** (跨越 2022 年智慧型手機/PC 庫存去化週期)

---

## 💵 四、 籌碼面與資本回饋 (Shareholder Yield)

- **現金股利殖利率 (Dividend Yield)**: **0.77%** (穩定持續調升每季現金股利)
...
```
      ...
      P5 (5% 極端下限)      P25 (保守分位)        P50 (中位數)       P75 (樂觀分位)      P95 (95% 機率上限)
        $178.78           $217.74        $252.34       $292.86           $372.14
```

- **平均內在價值 (Mean Intrinsic Value)**: **$260.44 USD**
- **中位數內在價值 (Median Intrinsic Value)**: **$252.34 USD**
- **50% 主流估值區間 (P25 ~ P75)**: **$217.74 ~ $292.86 USD**
- **95% 機率上限 (P95 Bullish Ceiling)**: **$372.14 USD**

*現價 ($403.41 美元) 位於蒙地卡羅估值中高位階，華爾街機構最新目標價（如 Needham）已調升至 **$530 USD**，反映對 2nm 製程溢價與 CoWoS 產能開出的高度樂觀。*
