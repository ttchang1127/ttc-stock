...
- **現價 $218.72 相對中位數**: 高於中位數 **306.4%**
- **現價隱含的 FCF 年成長率**: **43.8%**（在 WACC 14.45% 與同組終端假設下，讓模型值等於現價所需的成長率）

> 🚨 **中位數 $53.82 與現價 $218.72 相差 -75%，超過 ±50% 門檻。這個幅度通常反映假設不適用，而非市場錯價 —— 請以下方的隱含成長率判讀，不要把中位數當成目標價**
