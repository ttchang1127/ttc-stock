...
> 📌 假設來源：`dcf_assumptions.json`（CAPM 推導：beta 2.16 × ERP 5.0% + Rf 3.71%，稅後 Kd 4.13% 加權；營收 CAGR 22.50%）。基期自由現金流 $1,519 百萬，預測 10 年後接終端價值，共 10,000 次有效模擬。

| 分位 | P5 | P25 | P50 (中位數) | P75 | P95 |
|---|---|---|---|---|---|
| 每股內在價值 | $31.16 | $43.30 | **$55.13** | $70.04 | $98.92 |

- **平均內在價值**: **$58.81**
- **50% 主流估值區間 (P25 ~ P75)**: **$43.30 ~ $70.04**
- **現價 $218.72 相對中位數**: 高於中位數 **296.7%**
- **現價隱含的 FCF 年成長率**: **43.3%**（在 WACC 14.25% 與同組終端假設下，讓模型值等於現價所需的成長率）

> 🚨 **中位數 $55.13 與現價 $218.72 相差 -75%，超過 ±50% 門檻。這個幅度通常反映假設不適用，而非市場錯價 —— 請以下方的隱含成長率判讀，不要把中位數當成目標價**
