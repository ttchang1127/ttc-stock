...
- **近 3 年 Sortino Ratio（週資料）**: **1.69**　（2023-09-08 ~ 2026-09-02，156 週報酬）
- **近 5 年 Sortino Ratio（週資料）**: **1.17**　（2021-09-03 ~ 2026-09-02，261 週報酬）

**對照公開篩選器（日資料）**

- **近 12 個月 Sortino Ratio（日資料，MAR=0）**: **3.17**　（2025-09-02 ~ 2026-09-02，252 個交易日）
  - 若改以無風險利率為門檻（3.67%，^IRX 13週美國國庫券，期間平均）則為 **3.08**
...
> 📌 本節全部由 SEC 財報數字與 `prices.json` 收盤價計算，股價為 2026-09-02 之 $206.48。
...
- **庫藏股回購**: **$2,040 百萬**　→ 回購殖利率 **1.13%**
- **現金股利**: **$205 百萬**　→ 股利殖利率 **0.11%**
- **股東總殖利率 (Shareholder Yield)**: **1.24%**
...
- **現價 $206.48 相對中位數**: 高於中位數 **284.6%**
- **現價隱含的 FCF 年成長率**: **42.9%**（在 WACC 14.45% 與同組終端假設下，讓模型值等於現價所需的成長率）

> 🚨 **中位數 $53.69 與現價 $206.48 相差 -74%，超過 ±50% 門檻。這個幅度通常反映假設不適用，而非市場錯價 —— 請以下方的隱含成長率判讀，不要把中位數當成目標價**
