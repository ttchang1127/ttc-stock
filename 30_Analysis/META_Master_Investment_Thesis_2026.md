...
- **Altman Z-Score**: **12.76** (遠高於 2.99 安全區)
- **DuPont ROE**: **37.79%** (淨利率 30.08% $	imes$ 週轉率 0.804x $	imes$ 權益乘數 1.562x)

---

## 📈 三、 下行風險與二級市場波動分析 (Sortino Ratio)

- **近 3 年 Sortino Ratio (週資料)**: **1.10** 🌟 (從 2022 年底部暴漲拉升，展現極其強悍的上漲爆發力與低下行風險)
- **近 5 年 Sortino Ratio (週資料)**: **0.53** (跨越 2022 年元宇宙沉淪與數位廣告修正期)
