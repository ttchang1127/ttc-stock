...
> 📌 假設來源：`dcf_assumptions.json`（CAPM 推導：beta 2.64 × ERP 5.0% + Rf 3.71%；成長率＝營收 CAGR 19.54%）。基期自由現金流 $234 百萬，預測 10 年後接終端價值，共 10,000 次有效模擬。

| 分位 | P5 | P25 | P50 (中位數) | P75 | P95 |
|---|---|---|---|---|---|
| 每股內在價值 | $0.95 | $5.69 | **$9.89** | $15.35 | $26.36 |

- **平均內在價值**: **$11.26**
- **50% 主流估值區間 (P25 ~ P75)**: **$5.69 ~ $15.35**
- **現價 $379.13 相對中位數**: 高於中位數 **3733.5%**
- **現價隱含的 FCF 年成長率**: **65.0%**（在 WACC 16.90% 與同組終端假設下，讓模型值等於現價所需的成長率）

> ⚠️ 當期 FCF 193M 為常態化基準 234M 的 82%（歷年 FCF 利潤率中位數 4.0%）。基期採常態化值，以免單一年度的資本支出高峰被外推十年

> 🚨 **中位數 $9.89 與現價 $379.13 相差 -97%，超過 ±50% 門檻。這個幅度通常反映假設不適用，而非市場錯價 —— 請以下方的隱含成長率判讀，不要把中位數當成目標價**
