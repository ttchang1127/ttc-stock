...
- **DuPont ROE**: **0.82%**（淨利率 **0.85%** × 資產週轉率 **0.390x** × 權益乘數 **2.486x**）
- **ROE 直接驗算 (淨利 ÷ 股東權益)**: **0.82%**
...
- **近 3 年期 Sortino Ratio (週資料)**: **1.61**

---

## 💵 四、 估值比率與乘數分析 (P/E & Multiples)

- **當前本益比 (P/E Ratio)**: **89.5x**

---

## 🎲 五、 DCF 蒙地卡羅 10,000 次估值模擬

- **中位數內在價值 (Median Intrinsic Value)**: **$78.94 USD**
- **50% 核心估值區間 (P25 ~ P75)**: **$69.10 ~ $91.06 USD**
