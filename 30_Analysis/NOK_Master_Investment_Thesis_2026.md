...
- **DuPont ROE**: **3.15%**（淨利率 **3.32%** × 資產週轉率 **0.529x** × 權益乘數 **1.793x**）
- **ROE 直接驗算 (淨利 ÷ 股東權益)**: **3.15%**
...
- **近 3 年期 Sortino Ratio (週資料)**: **1.20**

---

## 💵 四、 估值比率與乘數分析 (P/E & Multiples)

- **當前本益比 (P/E Ratio)**: **24.0x**

---

## 🎲 五、 DCF 蒙地卡羅 10,000 次估值模擬

- **中位數內在價值 (Median Intrinsic Value)**: **$8.80 USD**
- **50% 核心估值區間 (P25 ~ P75)**: **$7.88 ~ $9.91 USD**
