...
- **近 3 年 Sortino Ratio（週資料）**: **1.57**　（2023-08-11 ~ 2026-08-11，157 週報酬）
- **近 5 年 Sortino Ratio（週資料）**: **0.64**　（2021-08-13 ~ 2026-08-11，261 週報酬）

**對照公開篩選器（日資料）**

- **近 12 個月 Sortino Ratio（日資料，MAR=0）**: **2.83**　（2025-08-11 ~ 2026-08-11，251 個交易日）
  - 若改以無風險利率為門檻（3.70%，^IRX 13週美國國庫券，期間平均）則為 **2.72**
...
> 📌 本節全部由 SEC 財報數字與 `prices.json` 收盤價計算，股價為 2026-08-11 之 €9.44。
...
- **現價 €9.44 相對中位數**: 高於中位數 **70.4%**
- **現價隱含的 FCF 年成長率**: **8.7%**（在 WACC 6.71% 與同組終端假設下，讓模型值等於現價所需的成長率）
